					...
					<div
						...
						<div className=" absolute top-0 left-0 w-full z-10 mt-10">
							...
							<div className="flex justify-between px-6 w-full items-center">
								...
								<button
									onClick={closeModal}
									className="text-white bg-[#00000067] absolute right-4 z-50 rounded-full p-2">
									<IoMdClose size={23} />
								</button>
							</div>
						</div>
						...
						<div className="relative flex  h-full   overflow-hidden">
							...
							<div
								className="absolute bottom-0 left-0 w-1/2 h-[100%] cursor-pointer z-10"
								onClick={prevStory}
							/>
							<div
								className="absolute bottom-0 right-0 w-1/2 h-[85%] cursor-pointer z-10"
								onClick={nextStory}
							/>
						</div>

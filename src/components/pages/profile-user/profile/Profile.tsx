...
const Profile = () => {
	...
	return (
		<section className="p-4 flex flex-col gap-4 pb-10">
			<div className="border border-[#E4E4E7] p-4 bg-white rounded-[8px] flex items-center justify-between gap-4">
				...
				<LinkButton href={PAGE.EDITPROFILE} className="bg-transparent !text-[#515151] border border-[#E4E4E7] rounded-[5px] w-[40px] h-[40px] !px-0">
					<FiEdit2 />
				</LinkButton>
			</div>
			...
			<div className="border border-[#E4E4E7] bg-white flex justify-between items-center rounded-[8px] w-full h-[130px] overflow-hidden">
				<div className="flex flex-col justify-between items-start gap-6 m-4  ">
					<div className="flex flex-col gap-2">
						...
						<div className="flex items-center gap-2">
							...
							<Description>
								За походы в магазин вы <br /> потратили бы 1000 часова
							</Description>
						</div>
					</div>
				</div>
				...
				<div className=" relative object-cover rounded-tr-[8px] w-[119px] h-[142px] rounded-br-[8px]">
					<Image fill objectFit="cover" src={watch} alt="img" />
				</div>
			</div>
			...
			<div className="border border-[#E4E4E7] bg-white rounded-[16px] flex items-center justify-between gap-4 p-4">
				...
				<Button onClick={() => setIsModalOpen(true)} className="bg-transparent !text-[#515151] border border-[#E4E4E7] rounded-[5px] w-[40px] h-[40px] !px-0">
					<FiEdit2 />
				</Button>
			</div>
			...
			<div className="border border-[#E4E4E7] bg-white rounded-[16px] flex items-center justify-between gap-4 p-4">
				...
				<LinkButton href={PAGE.ANALYTICS} className="bg-transparent !text-[#515151] border border-[#E4E4E7] rounded-[5px] w-[40px] h-[40px] !px-0">

...
const Total: React.FC<TotalProps> = ({ onProceedToCheckout }) => {
	...
	return (
		<section className="md:rounded-bl-[16px] md:rounded-br-[16px]  rounded-bl-[0px] rounded-br-[0px] rounded-tl-[16px] rounded-tr-[16px] bg-white border border-[#0071E3]">
			...
			<div className="p-4 flex flex-col gap-3 border-b border-[#0071E3]">
				<div className="flex items-center justify-between">
					...
					<Description className="text-[12px]">
						Это 100 000 с/в год{" "}
						<span className="text-[#0071E3] pl-2">5000 с</span>
					</Description>
				</div>
				<div className="flex items-center justify-between">
